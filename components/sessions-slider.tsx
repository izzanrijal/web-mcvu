...
export const sessions: Workshop[] = [
  ...
  },
  {
    ...
    rundown: [
      ...
      { time: "10.00-10.15", topic: "Coffee Break", speaker: "Panitia" },
      { time: "10.15-11.00", topic: "Therapeutic Management of Heart Failure in Pediatrics: Focused on Pharmacological Approaches", speaker: "dr. Sisca Natalia Siagian, Sp.JP(K), FIHA" },
      { time: "11.00-13.30", topic: "ISHOMA", speaker: "Panitia" },
